...
-- cliente (id, nome, email e telefone)
-- veiculo: (id, placa, ano, marca e id_cliente (Relacionar com a tabela cliente))
-- funcionário: (id, nome, funcao( gerente ou vendedor), salario, matricula, status( ativo ou inativo ))
...
-- LEGENDA PARA status_funcionario: 0 - Inativo | 1 - Ativo
	...
	INSERT INTO funcionarios (nome, funcao, salario, matricula, status_funcionario) VALUES ("Manuelzinho", "Vendedor", 1325.54, 12554, 0)
